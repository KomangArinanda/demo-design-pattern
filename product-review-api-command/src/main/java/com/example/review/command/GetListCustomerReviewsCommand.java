...
import com.example.review.command.request.GetListCustomerReviewsCommandRequest;
...
public class GetListCustomerReviewsCommand implements Command<GetListCustomerReviewsCommandRequest, List<ReviewDetailResponse>> {
    ...
    @Override
    public List<ReviewDetailResponse> execute(GetListCustomerReviewsCommandRequest request) {
        databaseLatencySimulator.delay();
        return repository.findByCustomerIdOrderByCreatedAtDesc(request.customerId())
            .stream()
