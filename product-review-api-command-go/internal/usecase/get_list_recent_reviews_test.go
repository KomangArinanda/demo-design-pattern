...
func TestGetListRecentReviews_Execute(t *testing.T) {
	...
	usecase := reviewuc.NewGetListRecentReviews(repository, service.NewProductReviewService())

	result := usecase.Execute(context.Background(), reviewuc.GetListRecentReviewsRequest{Limit: 2})
